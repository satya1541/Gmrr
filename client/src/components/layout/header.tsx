      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-12 sm:h-14">
          ...
          <div className="flex items-center animate-slide-in-left">
            <Link href="/">
              <button 
                className="focus:outline-none hover:opacity-80 transition-all duration-300 group relative"
            ...
            {navigation.map((item, index) => {
              ...
              return (
                <Link key={item.name} href={item.href}>
                  <button
                    className={cn(
                      "flex items-center px-3 py-1.5 rounded-xl text-sm font-medium transition-all duration-300 relative group overflow-hidden",
                      item.current
          ...
          {navigation.map((item, index) => {
            ...
            return (
              <Link key={item.name} href={item.href}>
                <button
                  className={cn(
                    "flex items-center w-full px-3 py-2 rounded-xl text-base font-medium transition-all duration-300 relative overflow-hidden group",
                    item.current
