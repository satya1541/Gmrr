  ...
  const verifyPin = async (enteredPin: string): Promise<boolean> => {
    try {
      ...
      if (error instanceof Error && error.name === 'AbortError') {
        console.warn('PIN verification timeout');
      } else {
        console.warn('PIN verification network error:', error);
      }
      return false;
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-full blur-2xl animate-pulse delay-1000"></div>
      ...
      <Card className="w-full max-w-md bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl shadow-black/20 relative overflow-hidden rounded-3xl">
        <div className="relative z-10">
          <CardHeader className="text-center space-y-8 pt-12 pb-8">
            ...
            <div className="space-y-3">
              ...
              <p className="text-white/70 text-base">Enter your 4-digit PIN to continue</p>
            </div>
          </CardHeader>
          ...
          <CardContent className="px-8 pb-12">
            <form onSubmit={(e) => { e.preventDefault(); }} className="space-y-8">
                ...
                {pin.map((digit, index) => (
                  <div key={index} className="relative">
                    <Input
                      ...
                      className="w-14 h-14 text-center text-xl font-mono bg-white/20 border-2 border-white/30 focus:border-cyan-400 focus:ring-4 focus:ring-cyan-400/20 rounded-xl text-white placeholder-white/50 backdrop-blur-sm transition-all duration-300"
                      maxLength={1}
              ...
              {error && (
                <div className="bg-red-500/20 border border-red-400/30 rounded-xl p-4 text-center backdrop-blur-sm">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center gap-2 text-yellow-300/80 bg-white/10 backdrop-blur-sm p-3 rounded-xl">
                ...
                {/* Status indicators */}
                {attempts > 0 && !isLocked && (
                  <div className="bg-yellow-500/20 border border-yellow-400/30 rounded-lg p-3 mt-4 backdrop-blur-sm">
                ...
                {isLocked && (
                  <div className="bg-red-500/20 border border-red-400/30 rounded-lg p-3 mt-4 backdrop-blur-sm">
