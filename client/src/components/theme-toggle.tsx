...
export const ThemeToggle = memo(function ThemeToggle() {
  ...
  return (
    <div
      className={cn(
        "relative w-[90px] h-[30px] rounded-full transition-all duration-300 shadow-md",
        getBackgroundColor()
      )}
    ...
    >
      ...
      <div
        className={cn(
          "absolute top-[5px] w-[20px] h-[20px] rounded-full bg-gray-800 dark:bg-gray-700 shadow-lg transition-all duration-300 flex items-center justify-center pointer-events-none",
          getSliderPosition(),
