      ...
      <CardContent className="p-6 relative z-10">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            ...
            <Button
              ...
              className={cn(
                "text-gray-700 hover:text-gray-900 dark:text-gray-300 dark:hover:text-gray-100 h-9 w-9 p-0 rounded-xl glass-button transition-all duration-300",
        ...
        <div className="space-y-3 mb-6">
          {hasData ? (
            <div className="p-4 rounded-2xl glass-enhanced border border-white/30 animate-slide-in-bottom">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-foreground/80 dark:text-white/90 drop-shadow-sm">
                  Alcohol Level
                </span>
                <div className="relative inline-flex items-center justify-end">
                  <span
                    aria-hidden="true"
                    className="pointer-events-none absolute inset-0 rounded-[2rem] bg-gradient-to-r from-cyan-400/50 via-indigo-500/40 to-fuchsia-500/40 blur-xl opacity-80"
                  />
                  <span className="relative inline-flex min-w-[4.5rem] justify-end items-center px-5 py-1.5 rounded-[1.8rem] text-3xl font-black tracking-tight text-slate-900 dark:text-white bg-gradient-to-br from-white/95 via-white/65 to-white/35 dark:from-slate-950/90 dark:via-slate-900/70 dark:to-slate-900/40 backdrop-blur-2xl ring-2 ring-white/80 dark:ring-white/25 shadow-[0_25px_45px_-30px_rgba(15,23,42,0.95)]">
            ...
            <div className="p-4 rounded-2xl glass-enhanced border border-white/30">
              <div className="flex justify-between items-center">
                <span className="text-sm font-semibold text-foreground/80 dark:text-white/85">Status</span>
                <span className={cn("font-semibold text-sm", {
                  "text-amber-400 drop-shadow": device.status === "waiting",
                  "text-rose-400 drop-shadow": device.status === "offline",
                  "text-emerald-400 drop-shadow": device.status === "online",
                })}>
          ...
          <div className="p-4 rounded-2xl glass-enhanced border border-white/30 animate-slide-in-bottom stagger-1">
            <div className="flex justify-between items-center">
              <span className="text-sm font-semibold text-foreground/80 dark:text-white/85">Last Seen</span>
        ...
        <div className="rounded-2xl overflow-hidden border border-white/30 bg-gray-100 dark:bg-black/20">
          <div className="h-80 lg:h-96">
            {hasData ? (
              <div 
                className="w-full h-full p-4 flex flex-col cursor-pointer bg-gray-100 dark:bg-black/20 hover:bg-gray-200 dark:hover:bg-white/10 transition-all duration-300 group/chart relative"
