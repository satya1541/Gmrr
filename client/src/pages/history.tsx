...
import { HistoryTourControl } from "@/components/history-tour-control";
  ...
  return (
    <div className="min-h-screen">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="mb-6" data-tour="history-header">
        ...
        {/* Filters */}
        <Card className="mb-6 bg-white/90 backdrop-blur-sm border-gray-200/50" data-tour="history-filters">
          <CardHeader>
            <CardTitle className="text-lg">Filters</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              <div data-tour="device-selector">
              ...
              <div className="flex items-end" data-tour="export-button">
                <Button
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-gray-200/50">
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="overflow-x-auto" data-tour="data-table">
