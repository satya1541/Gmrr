...
import gmrLogo from "@assets/image_1765606162421.png";
...
export default function History() {
  ...
  const handleExportPdf = async () => {
    ...
    try {
      ...
      doc.text("ToxiShield-X", 50, 18);
      
      doc.setFontSize(14);
      doc.setTextColor(0, 0, 0);
      doc.text(`Device History Report`, 14, 32);
      
      doc.setFontSize(10);
      doc.setTextColor(100, 100, 100);
      doc.text(`Device: ${deviceName}`, 14, 40);
      doc.text(`Generated: ${format(new Date(), "MMM dd, yyyy HH:mm:ss")}`, 14, 46);
      doc.text(`Total Records: ${pdfData.data.length} (Export Limit: ${exportLimit})`, 14, 52);
      const yOffset = 58;
