...
import { Plus, Edit, Trash2, Trash, RefreshCw, AlertTriangle, Shield, Database, Settings, Zap, Activity, Users, Clock, CheckCircle2, XCircle, AlertCircle, Calendar, MonitorSpeaker, Signal } from "lucide-react";
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
          ...
          <Card className="glass-enhanced border-0 shadow-xl hover-lift animate-bounce-in stagger-1 overflow-hidden group">
            <CardContent className="p-4 sm:p-6 relative">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium mb-1">Total Devices</p>
                  <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white animate-counter-up">{totalDevices}</h3>
                </div>
          ...
          <Card className="glass-enhanced border-0 shadow-xl hover-lift animate-bounce-in stagger-2 overflow-hidden group">
            <CardContent className="p-4 sm:p-6 relative">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium mb-1">Online</p>
                  <h3 className="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 animate-counter-up">{onlineDevices}</h3>
                </div>
          ...
          <Card className="glass-enhanced border-0 shadow-xl hover-lift animate-bounce-in stagger-3 overflow-hidden group">
            <CardContent className="p-4 sm:p-6 relative">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium mb-1">Waiting</p>
                  <h3 className="text-2xl sm:text-3xl font-bold text-yellow-600 dark:text-yellow-400 animate-counter-up">{waitingDevices}</h3>
                </div>
          ...
          <Card className="glass-enhanced border-0 shadow-xl hover-lift animate-bounce-in stagger-4 overflow-hidden group">
            <CardContent className="p-4 sm:p-6 relative">
              ...
              <div className="flex items-center justify-between relative z-10">
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 font-medium mb-1">Offline</p>
                  <h3 className="text-2xl sm:text-3xl font-bold text-red-600 dark:text-red-400 animate-counter-up">{offlineDevices}</h3>
                </div>
        ...
        <Tabs defaultValue="devices" className="space-y-6">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="divide-y bg-white divide-gray-200">
                  {devices.map((device) => (
                    <tr key={device.id} className="transition-colors duration-200 hover:bg-gray-50">
          ...
          <TabsContent value="system">
            ...
            <div className="max-w-2xl mx-auto mb-6">
              ...
              <Card className="border shadow-sm rounded-lg relative overflow-hidden border-gray-200 bg-white">
                <CardContent className="p-4 relative z-10">
                  <div className="mb-4">
                    <h2 className="text-lg font-semibold text-gray-900 mb-1">Manage Cleanup</h2>
