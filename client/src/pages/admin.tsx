    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8">
        ...
        <Tabs defaultValue="devices" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 bg-white/90 backdrop-blur-sm border-0 shadow-lg rounded-xl p-1">
          ...
          <TabsContent value="system">
            {/* Clean System Settings Layout */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              {/* Left Side - Manage Cleanup */}
              <Card className="border border-gray-200 shadow-sm rounded-lg bg-white">
                <CardContent className="p-6">
                  <div className="mb-6">
                    <h2 className="text-xl font-semibold text-gray-900 mb-2">Manage Cleanup</h2>
                    <p className="text-gray-600 text-sm">
                      Schedule automated maintenance and decide data retention
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 mb-6">
                    {isLoadingCleanup ? (
                      ...
                      <>
                        ...
                        {/* Cleanup Interval */}
                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                          <span className="text-sm font-medium text-gray-700">Cleanup Interval</span>
                          <span className="text-sm font-semibold text-gray-900">
                        ...
                        {cleanupStatus?.config?.nextCleanup && (
                          <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                            <span className="text-sm font-medium text-gray-700">Next Cleanup</span>
                            <span className="text-sm font-semibold text-gray-900">
                              {new Date(cleanupStatus.config.nextCleanup).toLocaleDateString()} at {new Date(cleanupStatus.config.nextCleanup).toLocaleTimeString('en-US', { hour12: false })}
                            </span>
                          </div>
                        )}
                      </>
              ...
              <Card className="border border-gray-200 shadow-sm rounded-lg bg-white">
                <CardContent className="p-6">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600 text-sm">
                      Actions in this zone are irreversible
                    </p>
                  </div>

                  {/* Clear All Device Data Card */}
                  <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Clear All Device Data</h3>
                    <p className="text-gray-600 text-sm">
                      Permanently delete all historical sensor data
                    </p>
                  </div>
                  ...
                  <Button
                    ...
                    className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-3 rounded-lg transition-colors duration-200 mb-4"
                    data-testid="button-clear-all-data"
                  >
                    {completeCleanupMutation.isPending ? (
                      <RefreshCw className="h-4 w-4 mr-2 animate-spin" />
                    ) : (
                      <Trash2 className="h-4 w-4 mr-2" />
                    )}
                    {completeCleanupMutation.isPending ? "Clearing All Data..." : "Clear All Data"}
                  </Button>
                  ...
                  <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-yellow-800 mb-1">Critical Warning</p>
                        <p className="text-sm text-yellow-700 leading-relaxed">
                          This will permanently delete ALL device data records from the database. 
