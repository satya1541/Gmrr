...
import { Plus, Edit, Trash2, Trash, RefreshCw, AlertTriangle, Shield, Database, Settings, Zap, Activity, Users, Clock, CheckCircle2, XCircle, AlertCircle, Calendar, MonitorSpeaker } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8 relative z-10">
        ...
        <Tabs defaultValue="devices" className="space-y-6">
          ...
          <TabsContent value="devices">
            ...
            <Card className="border-0 shadow-xl rounded-2xl overflow-hidden relative bg-white">
          <CardHeader className="p-6 sm:p-8 border-b relative z-10 bg-gradient-to-r from-gray-50 to-blue-50/50 border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <Card className="border shadow-sm rounded-lg relative overflow-hidden border-gray-200 bg-white">
                <CardContent className="p-4 relative z-10">
                  ...
                  <Button 
                    ...
                    className="w-full bg-gray-900/90 hover:bg-gray-800/90 text-white font-medium py-2 rounded transition-all duration-200 backdrop-blur-sm shadow-lg border border-gray-700/50"
