...
import { AdminTourControl } from "@/components/admin-tour-control";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8">
        {/* Enhanced Header */}
        <div className="mb-8 sm:mb-10" data-tour="admin-header">
        ...
        <Tabs defaultValue="devices" className="space-y-6">
          <TabsList className="grid w-full grid-cols-3 bg-white/90 backdrop-blur-sm border-0 shadow-lg rounded-xl p-1" data-tour="admin-tabs">
            ...
            <TabsTrigger value="visitors" className="flex items-center gap-2 rounded-lg" data-tour="visitor-tab">
              <Users className="h-4 w-4" />
              <span className="hidden sm:inline">Visitor Tracking</span>
              <span className="sm:hidden">Visitors</span>
            </TabsTrigger>
            <TabsTrigger value="system" className="flex items-center gap-2 rounded-lg" data-tour="system-tab">
          ...
          <CardContent className="p-0" data-tour="devices-table">
              ...
              <Card className="border border-gray-200 shadow-sm rounded-lg bg-white">
                <CardContent className="p-4">
                  ...
                  <Button 
                    ...
                    className="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-2 rounded transition-colors duration-200"
