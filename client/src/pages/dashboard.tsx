    ...
    <div className="min-h-screen">
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-6 sm:mb-8 animate-slide-in-bottom stagger-3">
          <h2 className="text-xl sm:text-2xl font-bold text-white drop-shadow-md dark:text-white mb-6 flex items-center gap-3">
            <span className="w-1 h-8 bg-gradient-to-b from-blue-500 to-purple-500 rounded-full"></span>
            <span className="px-3 py-1 rounded-2xl bg-white/10 backdrop-blur-lg border border-white/20 text-white dark:bg-transparent dark:border-transparent">
              Device Monitoring
            </span>
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
